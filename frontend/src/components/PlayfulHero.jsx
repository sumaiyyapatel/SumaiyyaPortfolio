        ...
        <div className="relative z-10 text-center px-6 max-w-6xl">
          ...
          <div ref={titleRef} className="mb-4 sm:mb-6 md:mb-8">
            <div className="flex justify-center gap-1 sm:gap-2 mb-2 sm:mb-4 flex-wrap">
              <span className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-black leading-none text-white title-shadow">SUMAIYYA</span>
            </div>
            <div className="flex justify-center gap-1 sm:gap-2 flex-wrap ">
              <span className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-black leading-none text-transparent title-stroke ">PATEL</span>
            </div>
          </div>
